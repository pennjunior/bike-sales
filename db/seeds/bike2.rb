puts "Seeding additional ATVs (bike2)..."
...
puts "Created: #{trailblazer.model}"
trailblazer_urls = [
...
puts "Created: #{brute_force.model}"
brute_force_urls = [
