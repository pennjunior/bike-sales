...
# rzr_pro_xp_ultimate = Bike.create!(
...
#   registration_status: "registered",
#   last_modified: Date.new(2022),
#   description: "925cc turbocharged engine for extreme off-road performance",
#   features: "• Turbocharged 925cc twin-cylinder engine delivering unmatched power and acceleration
#   • High-strength suspension system with 22 inches of usable travel for smooth rides on extreme terrains
#   • DYNAMIX 2.0 active suspension system with mode adjustment for optimized performance on any terrain
#   • 4-point harness and bolstered seats for secure and comfortable driving during intense off-road experiences
#   • 30-inch Maxxis Carnivore tires for superior grip on rocky and muddy trails
#   • 14-inch ground clearance, ensuring smooth navigation over challenging obstacles
#   • Advanced Ride Command technology with GPS navigation, Bluetooth connectivity, and a high-resolution display
#   • LED lighting package for enhanced visibility during night drives
#   • Durable frame and body design to withstand extreme conditions
#   • Premium interior with modern controls and ample storage options for gear",
#   price: 23999,
#   stock: 3,
#   maximum_speed: 120,
#   fuel_type: "Petrol",
...
#   category_id: utv_category_id,
# )
# rzr_pro_xp_ultimate_urls = [
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179486/670d7e2f60779444df0ff10b_odwmgx.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179486/670d7e2a5ceca37ec57df4bf_wacvuy.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179486/670d7e2ab769b64f8200a723_mnz8bi.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179487/670d7e3af2e21f053307fb63_oqmjz1.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179487/670d7e657b74b63daf32719a_rswczd.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179487/670d7e3898426f2ecd05240f_yyucva.jpg"
# ]
# rzr_pro_xp_ultimate_urls.each_with_index do |url, index|
#   file = URI.open(url)
#   rzr_pro_xp_ultimate.photos.attach(io: file, filename: "rzr_pro_xp_ultimate_#{index + 1}", content_type: "image/jpg")
# end
# puts "Images attached for rzr_pro_xp_ultimate = #{rzr_pro_xp_ultimate.photos.attached?}"
# # number 2
# wolverine_rmax2 = Bike.create!(
#   model: "Wolverine RMAX2 1000 XT-R",
#   kilometers: 5,
#   body: "Utility",
#   colour: "Green",
#   engine_capacity: 999,
...
#   description: "999cc DOHC engine with adventure-ready features",
#   features: "• 999cc twin-cylinder DOHC engine with impressive horsepower and torque
#   • FOX QS3 shocks with adjustable suspension for unparalleled ride comfort
#   • WARN winch with a 4,500 lbs capacity for tackling tough jobs and recovery situations
#   • Full skid plates for added protection during off-road adventures
#   • On-Command 4WD system with a differential lock for precise handling in tough terrains
#   • 30-inch GBC Dirt Commander tires for superior off-road performance
#   • Comfortable seating for two passengers with ergonomic features
#   • LED headlights and taillights for enhanced visibility in low-light conditions
#   • Durable cargo bed with a 600 lbs capacity for hauling gear or supplies
#   • Advanced safety features like seatbelts and side nets",
#   price: 19999,
#   stock: 5,
#   maximum_speed: 105,
#   fuel_type: "Petrol",
...
#   category_id: utv_category_id,
# )
# wolverine_rmax2_urls = [
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179896/672a468446e24c5003377485_woejje.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179896/672a468546e24c5003377487_wpb4dl.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179897/672a468646e24c5003377489_zgofxt.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179896/672a468f46e24c500337749c_qt35jk.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179896/672a468446e24c5003377485_woejje.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179896/672a468446e24c5003377486_fy4ldd.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179895/672a468e46e24c500337749b_jpt3qo.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179895/672a468d46e24c5003377499_ownndk.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179895/672a468a46e24c5003377492_ageppj.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179899/672a468546e24c5003377488_n51imh.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179898/672a468746e24c500337748c_uav3om.jpg",
#   "https://res.cloudinary.com/drxr1eiwp/image/upload/v1733179897/672a468846e24c500337748e_1_swfqqs.jpg"
# ]
# wolverine_rmax2_urls.each_with_index do |url, index|
#   file = URI.open(url)
#   wolverine_rmax2.photos.attach(io: file, filename: "wolverine_rmax2_#{index + 1}", content_type: "image/jpg")
# end
# puts "Images attached for wolverine_rmax2 = #{wolverine_rmax2.photos.attached?}"
# #number 3
