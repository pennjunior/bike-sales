...
ActiveRecord::Schema[7.1].define(version: 2024_12_15_041617) do
  ...
  create_table "saved_bikes", force: :cascade do |t|
    t.bigint "bike_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["bike_id"], name: "index_saved_bikes_on_bike_id"
    t.index ["user_id"], name: "index_saved_bikes_on_user_id"
  end
  ...
  add_foreign_key "saved_bikes", "bikes"
  add_foreign_key "saved_bikes", "users"
end
